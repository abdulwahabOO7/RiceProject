...
function InternationalBrand() {
  const products = [
    {
      id: 1,
      name: "Safeena Classic Aged (5 kg) - Export Quality",
      price: "RS.2,695.00",
      type: "Steam"
    },
    {
      id: 2,
      name: "Safeena Sella Aged (5 kg) - Export Quality",
      price: "RS.2,595.00",
      type: "Sella"
    }
  ]
  ...
  return (
    <section ref={sectionRef} className="international-brand-section">
      <div className="section-container">
        <h2 ref={titleRef} className={`section-title ${isTitleVisible ? 'animate-in' : ''}`}>International Brand</h2>
